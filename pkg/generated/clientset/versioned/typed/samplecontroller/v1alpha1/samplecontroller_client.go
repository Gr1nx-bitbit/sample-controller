...
import (
	...
	"github.com/Gr1nx-bitbit/pod-customizer/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type SamplecontrollerV1alpha1Interface interface {
	RESTClient() rest.Interface
	PodCustomizersGetter
}
...
func (c *SamplecontrollerV1alpha1Client) PodCustomizers(namespace string) PodCustomizerInterface {
	return newPodCustomizers(c, namespace)
}
